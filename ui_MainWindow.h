...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        addCustomerName->setMaxLength(64);
        ...
        addCustomerAddress->setMaxLength(64);
        ...
        verticalLayoutWidget_5->setGeometry(QRect(420, 10, 311, 145));
        ...
        findCustomerName->setMaxLength(64);
